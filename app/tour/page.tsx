...
const MockCreateRoom = () => (
    <div className="bg-card p-4 rounded-xl shadow-lg border border-border w-full max-w-sm mx-auto transform rotate-1 hover:rotate-0 transition-transform duration-500">
        <h3 className="text-lg font-bold text-card-foreground mb-4">Create New Khata</h3>
        <div className="space-y-3">
            <div className="h-10 bg-muted rounded-lg w-full animate-pulse"></div>
            <div className="h-10 bg-muted rounded-lg w-full animate-pulse delay-75"></div>
...
const MockRoomCode = () => (
    <div className="bg-card p-6 rounded-xl shadow-lg border border-border w-full max-w-sm mx-auto flex flex-col items-center text-center transform -rotate-1 hover:rotate-0 transition-transform duration-500">
        ...
        <h3 className="font-bold text-card-foreground">Invite Members</h3>
        <p className="text-sm text-muted-foreground mb-4">Share this code with your roommates</p>
        <div className="bg-muted px-6 py-3 rounded-lg border-dashed border-2 border-border">
            <span className="text-3xl font-mono font-bold tracking-widest text-card-foreground">8294</span>
        </div>
    </div>
);
...
const MockExpense = () => (
    <div className="bg-card p-4 rounded-xl shadow-lg border border-border w-full max-w-sm mx-auto transform rotate-1 hover:rotate-0 transition-transform duration-500">
        <div className="flex justify-between items-center mb-4">
            <span className="font-bold text-muted-foreground">New Expense</span>
        ...
        <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm font-bold text-card-foreground">Groceries</p>
                        <p className="text-xs text-slate-500">Shared by 4</p>
                    </div>
                </div>
                <span className="font-bold text-card-foreground">৳2,500</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-orange-100 dark:bg-orange-900/50 flex items-center justify-center">⚡</div>
                    <div>
                        <p className="text-sm font-bold text-card-foreground">WiFi Bill</p>
                        <p className="text-xs text-slate-500">Shared by 4</p>
                    </div>
                </div>
                <span className="font-bold text-card-foreground">৳1,000</span>
            </div>
        </div>
    </div>
);
    ...
    <div className="bg-card p-4 rounded-xl shadow-lg border border-border w-full max-w-sm mx-auto transform rotate-1 hover:rotate-0 transition-transform duration-500">
        ...
        <div className="flex justify-between items-center mb-3 p-2 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-100 dark:border-green-900/30">
            ...
            <div className="text-right">
                ...
                <p className="font-bold text-card-foreground">142 Meals</p>
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3">
            ...
            <div className="bg-muted p-2 rounded-lg border border-border">
                <h4 className="font-bold text-xs text-muted-foreground flex items-center gap-1 mb-2">
                    <MenuBookIcon className="w-3 h-3 text-orange-500" /> Today's Menu
                </h4>
                <div className="space-y-1.5 pl-1">
                    <p className="text-xs flex gap-2"><span className="text-slate-400 w-3">☀️</span> <span className="text-muted-foreground">Egg & Toast</span></p>
                    <p className="text-xs flex gap-2"><span className="text-slate-400 w-3">🕛</span> <span className="text-muted-foreground">Chicken Curry</span></p>
                    <p className="text-xs flex gap-2"><span className="text-slate-400 w-3">🌙</span> <span className="text-muted-foreground">Fish Fry</span></p>
                </div>
            </div>
            ...
            <div className="space-y-2">
                <div className="flex justify-between items-center">
                    <h4 className="font-bold text-xs text-muted-foreground flex items-center gap-1"><ShoppingCartIcon className="w-3 h-3 text-blue-500" /> Shopper</h4>
                ...
                <div className="border-t border-border pt-2">
                    <h4 className="font-bold text-xs text-muted-foreground flex items-center gap-1 mb-1"><MealIcon className="w-3 h-3 text-purple-500" /> Who's Eating?</h4>
                    <div className="flex justify-between items-center text-xs bg-muted p-1.5 rounded">
...
const MockStaff = () => (
    <div className="bg-card p-5 rounded-xl shadow-lg border border-border w-full max-w-sm mx-auto transform rotate-1 hover:rotate-0 transition-transform duration-500">
        <div className="flex items-center gap-3 mb-4">
            <BriefcaseIcon className="w-6 h-6 text-primary-500" />
            <h3 className="font-bold text-card-foreground">Household Services</h3>
        </div>
        <div className="space-y-3">
            <div className="bg-muted p-3 rounded-lg flex items-center justify-between border border-border">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-600 flex items-center justify-center text-lg">🧹</div>
                    <div>
                        <p className="font-bold text-card-foreground text-sm">Fatima Begum</p>
            ...
            <div className="bg-muted p-3 rounded-lg flex items-center justify-between border border-border">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-600 flex items-center justify-center text-lg">🔧</div>
                    <div>
                        <p className="font-bold text-card-foreground text-sm">Nosin Miah</p>
...
const MockReports = () => (
    <div className="bg-card p-4 rounded-xl shadow-lg border border-border w-full max-w-sm mx-auto transform -rotate-1 hover:rotate-0 transition-transform duration-500">
        <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-bold text-card-foreground">Monthly Breakdown</h3>
        </div>
...
const TourStep: React.FC<{
    ...
    <div
        onClick={onClick}
        className={`cursor-pointer transition-all duration-300 flex flex-col md:flex-row gap-6 md:gap-12 items-center p-6 rounded-2xl border-2 ${isActive ? 'bg-card border-primary-500 shadow-xl scale-[1.02]' : 'bg-transparent border-transparent hover:bg-muted opacity-60 hover:opacity-100'}`}
    >
        <div className="flex-1 text-center md:text-left order-2 md:order-1">
            <div className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold mb-3 ${isActive ? 'bg-primary-500 text-white' : 'bg-muted text-muted-foreground'}`}>
                {stepNumber}
            </div>
            <h3 className={`text-2xl font-bold mb-2 ${isActive ? 'text-card-foreground' : 'text-muted-foreground'}`}>{title}</h3>
            <p className="text-muted-foreground text-lg leading-relaxed mb-4">{description}</p>
            {isActive && features && (
...
export default function TourPage() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans">
            {/* Header */}
            <header className="py-6 px-6 md:px-12 flex justify-between items-center bg-card shadow-sm sticky top-0 z-50">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 md:py-20">
                <div className="text-center mb-16 space-y-4 animate-fade-in">
                    <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-foreground tracking-tight">
                ...
                <div className="space-y-4 relative">
                    ...
                    <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-border -translate-x-1/2 rounded-full hidden md:block -z-10"></div>
                ...
                <div className="mt-16 sm:mt-24 text-center space-y-8 bg-gradient-to-br from-primary-500/10 to-purple-500/10 p-6 sm:p-12 rounded-3xl border border-primary-500/20">
                    <h2 className="text-3xl font-bold text-foreground">Ready to simplify your shared living?</h2>
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        ...
                        <Link href="/" className="px-8 py-4 text-lg font-bold rounded-xl bg-card text-card-foreground hover:bg-muted border border-border transition-all hover:shadow-lg hover:-translate-y-1 flex items-center justify-center gap-2">
