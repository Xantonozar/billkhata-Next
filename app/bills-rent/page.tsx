...
export default function RentBillsPage() {
    ...
    const handleMarkAsPaid = async () => {
        ...
        if (updatedBill) {
            ...
            refreshNotifications(); // Refresh notifications after payment submission
        }
    ...
    const handleApprovePayment = async (billId: string, userId: string) => {
        ...
        if (updatedBill) {
            ...
            refreshNotifications(); // Refresh notifications after approval
        }
    };
    ...
    const handleDenyPayment = async (billId: string, userId: string) => {
        ...
        if (updatedBill) {
            ...
            refreshNotifications(); // Refresh notifications after denial
        }
    };
