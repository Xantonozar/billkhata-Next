...
import { OtherIcon, ArrowLeftIcon, PlusIcon } from '@/components/Icons';
...
const ICON = <OtherIcon className="w-8 h-8 text-slate-500" />;
                    ...
                    {selectedMonthBills.length === 0 ? (
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            {selectedMonthBills.map((bill) => (
                                <div key={bill.id}>
                                    {(user.role === Role.Manager || user.role === Role.MasterManager) ? renderManagerView(bill) : renderMemberView(bill)}
                                </div>
                            ))}
                        </div>
                    )}
